...
function HeroSection() {
  return (
    <Box id="home" component="main" sx={heroWrapperSx}>
      <Grid container spacing={4} alignItems="center">
        <Grid item xs={12} sm={12} sx={heroTitleGridSx}>
          <motion.div
        ...
        <Grid item xs={12} sm={6} sx={heroImageGridSx}>
          <Box
            component="img"
            src={UpdatedPhoto}
            alt="My Picture"
        ...
        <Grid item xs={12} sm={6}>
          <motion.div
            ...
            transition={{ duration: 1 }}
          >
            <Typography variant="body1" sx={heroParagraphSx}>
            ...
            <Typography variant="body1" sx={heroBodyTextSx}>
