      ...
      <Grid container spacing={4} alignItems="center">
        ...
        <Grid item xs={12} sm={6}>
          <motion.div
            ...
            transition={{ duration: 1 }}
          >
            <Typography variant="body1" sx={{ textAlign: "justify", fontSize: { xs: "14px", sm: "16px" }, marginBottom: "2vh" }}>
            ...
            <Typography variant="body1" sx={{ textAlign: "justify", fontSize: { xs: "14px", sm: "16px" } }}>
